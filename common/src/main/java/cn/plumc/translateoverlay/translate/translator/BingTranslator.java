...
public class BingTranslator extends Translator {
    ...
    public void update() {
        ...
        if (IGMatcher.find() && IIDMatcher.find() && tokenDataMatcher.find()){
            ...
            ChatTranslator.sendBypassMessage(new TranslatableText("message.translateoverlay.translator.bing.update_error"));
        }
    }
    ...
    private String readTranslated(String response) {
        ...
        try {
            ...
            ChatTranslator.sendBypassMessage(new TranslatableText("message.translateoverlay.translator.bing.response_error"));
            return null;
