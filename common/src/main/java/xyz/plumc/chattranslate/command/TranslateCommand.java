...
import xyz.plumc.chattranslate.translates.*;
...
public class TranslateCommand {
    ...
    public static int translateBook(){
        if (MinecraftClient.getInstance().currentScreen instanceof BookScreen bookViewScreen){
            ...
            ChatTranslator.sendBypassMessage(Text.translatable("commands.translate.book.message"));
    ...
    public static int translateLectern(){
        ...
        if (rayTraceResult.getType()== HitResult.Type.BLOCK){
            ...
            if (blockEntity instanceof LecternBlockEntity){
                ChatTranslator.sendBypassMessage(Text.translatable("commands.translate.lectern.message"));
    ...
    public static int translateSign(){
        ...
        if (rayTraceResult.getType()== HitResult.Type.BLOCK) {
            ...
            if (blockEntity instanceof SignBlockEntity){
                ChatTranslator.sendBypassMessage(Text.translatable("commands.translate.sign.message"));
