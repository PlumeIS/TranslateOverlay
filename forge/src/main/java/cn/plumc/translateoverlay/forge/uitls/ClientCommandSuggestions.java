package cn.plumc.translateoverlay.forge.uitls;
...
public class ClientCommandSuggestions extends CommandSuggestor {
	...
	public void refresh() {
		...
		if (chatInput.startsWith("!")) {
			...
			if (canParse) {
				CommandDispatcher<CommandSource> dispatcher = (CommandDispatcher<CommandSource>) (CommandDispatcher<?>) TranslateOverlayForge.DISPATCHER;
