package cn.plumc.translateoverlay.fabric.command.argument;
...
public class LanguageArgument implements ArgumentType<Language> {
    ...
    public static Language getLanguage(CommandContext<FabricClientCommandSource> context, String argument){
