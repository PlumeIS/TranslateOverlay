        ...
        if( future ==null ){
            ...
            Callable<String> callable = () -> {
                try {
                    ...
                    ChatTranslator.sendBypassMessage(Text.translatable("message.translateoverlay.translator.error"));
                    ChatTranslator.sendBypassMessage(Text.literal(e.getMessage()));
                }
                return I18n.translate("message.translateoverlay.translator.error");
            };
