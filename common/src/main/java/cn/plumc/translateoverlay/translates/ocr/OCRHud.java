...
public class OCRHud {
    ...
    public void render(MatrixStack matrixStack, Integer mouseX, Integer mouseY, float deltaTime) {
        ...
        if (lastInfo!=null) {
            if (infoEndAnimation.step>=infoEndAnimation.end-1){
                ...
                DrawableHelper.drawTextWithShadow(matrixStack, minecraft.textRenderer, lastInfo, minecraft.getWindow().getScaledWidth() - minecraft.textRenderer.getWidth(lastInfo) - minecraft.textRenderer.fontHeight/2, minecraft.textRenderer.fontHeight / 2, (TEXT_COLOR | (int)(255 * opacity) << 24));
            }
        }
        if (info!=null) {
            float opacity = infoStartAnimation.step();
            DrawableHelper.drawTextWithShadow(matrixStack, minecraft.textRenderer, info, minecraft.getWindow().getScaledWidth()  - minecraft.textRenderer.getWidth(info) - minecraft.textRenderer.fontHeight/2, minecraft.textRenderer.fontHeight/2, (TEXT_COLOR | (int)(255 * opacity) << 24));
        }
    ...
    private void renderText(MatrixStack matrixStack, String text, int x, int y, int s, int color){
        ...
        DrawableHelper.drawTextWithShadow(matrixStack, font, text, x+2, y-s-font.fontHeight-2, color);
    }
