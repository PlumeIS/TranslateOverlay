...
public class BingTranslator extends Translator {
    ...
    public void update() {
        ...
        if (IGMatcher.find() && IIDMatcher.find() && tokenDataMatcher.find()){
            ...
            ChatTranslator.sendBypassMessage(Text.translatable("message.chattranslate.translator.bing.update_error"));
        }
    }
    ...
    private String readTranslated(String response) {
        ...
        try {
            ...
            ChatTranslator.sendBypassMessage(Text.translatable("message.chattranslate.translator.bing.response_error"));
            return null;
