...
public class ConfigManager {
    ...
    public static final File CONFIG_FILE = new File("config/chattranslate.json");
    ...
    public JsonObject readDefaultConfig() throws IOException {
        URL url = getClass().getClassLoader().getResource("chattranslate.json");
        ...
        try {
            ...
            for (Field field : ConfigFile.class.getDeclaredFields()){
                ...
                if (Objects.isNull(value)){
                    ...
                    ChatTranslate.logger.info("Add a new config entry %s to config file.".formatted(field.getName()));
                    rewriting = true;
                }
